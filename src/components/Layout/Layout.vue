<template>
  <div class="kro-layout">
    <div v-if="!!$slots.drawer" class="kro-layout__scrim" :class="{ 'kro-layout__scrim--is-open': $attrs['is-drawer-open'] && (isSmallScreen || temporary) }" @click="$emit('update:is-drawer-open', false)" />
...
import { watchEffect, computed, ref, onUpdated } from 'vue'
