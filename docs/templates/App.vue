<template>
    <kro-app>
        <kro-layout
            ...
            <template #footer>
                <div class="container mx-auto grid grid-cols-4 pt-8">
                    <div class="p-4 flex col-span-4 md:col-span-3 lg:col-span-3 xl:col-span-3">
                        <span class="opacity-75 text-sm">&copy; 2020 Black Kro</span>
...
<script lang="ts" setup>
    ...
    export const { afterEach, currentRoute,  } = useRouter();
    export const { title, sidebar } = useConfiguration();
    export const { theme } = useTheme();
    export const { meta } = useMeta();

    export const isDrawerOpen = ref(true);
    ...
    afterEach((to, from, next) => { isDrawerOpen.value = false; });
