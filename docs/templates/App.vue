<template>
    <kro-app>
        <kro-layout fixed :class="$style.root">
            ...
            <template #footer>
                <div :class="$style.footer" class="content-container">
...
<style module lang="scss">
    ...
    @import '../../src/styles/general/breakpoints';
